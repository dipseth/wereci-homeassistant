...
<p align="center">
  <img src="docs/screenshots/dashboard-cooking.webp" alt="The weReci dashboard in Home Assistant while cooking: the live cook display fills the top of the page with the recipe's photo and the current step, then Back / Next / Stop and the Cook something form" width="880">
</p>
